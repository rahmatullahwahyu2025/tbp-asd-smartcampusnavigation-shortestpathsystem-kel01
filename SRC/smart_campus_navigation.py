...
# --- Edge berbobot (u, v, bobot_meter) acak (Murni Python), seed=7 -------------
def generate_edges(nodes, seed=7):
    # Menggunakan module random murni bawaan Python
    random.seed(seed)
    n = len(nodes)
    edges = []
    ...
    while True:
        try:
            ...
            if cmd == "BANTUAN":
                ...
                # Cari gedung yang tidak terhubung dengan Gerbang Utama (A1)
